    ...
    <? require_once('../nav.php'); ?>
     ...
     <div class="container mt-4">
        ...
        ?>
            ...
            <div class="col-md-12">
                <h2>Приём бочек на маслосклад</h2>
            </div>
            <div class="col-md-12">
                <div class="table-responsive-sm">
                    <table id="myTableDay" class=" table table-bordered table-striped table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT m.date_operations as date, 
                            ...
                            WHERE m.is_deleted = 0 AND mp.volume > 0 AND m.sign_of_calculation = 'priemka' ORDER BY m.date_operations;";
