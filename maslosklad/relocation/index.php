...
<html lang="en">
  <head>
    ...
    <title>ELDIR | МаслоСклад | Перемещение имущества</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12">
                <h1>ELDIR | МаслоСклад | Перемещение Имущества </h1>
            </div>
        </div>
                ...
                <div class="table-responsive-sm">
                    <table id="myTable" class=" table table-bordered table-striped table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT s.id as id, mpp.name as name_place, sp.name as property_name, s.summa as summa, spt.name as type_name, s.count, s.date_operations, spp.name as place, s.comment,  IF(s.status > 0, 'Оплачен', 'Не оплачен') AS status, IF(s.type_pay > 0, 'безнал', 'нал') AS type_pay, mb.name as buyers_name 
                                        FROM `maslosklad` s 
                                        ...
                                        LEFT JOIN `maslosklad_property_place` mpp ON s.place_id = mpp.id
                                        WHERE s.is_deleted = 0 AND s.sign_of_calculation = 'vydacha' AND s.relocation = 1";
