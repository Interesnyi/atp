     ...
     <div class="container mt-4">
        ...
        ?>
            ...
            <div class="col-md-12 mt-2">
                <h2>Остатки</h2>
                <p>Зелёным выделены целые бочки, жёлтым уже открытые.</p>
                <p>Посмотреть приём / выдачу в разделе <b><a href="barrel_bottling.php">ELDIR | Маслосклад | БОЧКИ -> "РОЗЛИВ".</a></b></p>
            </div>
            <div class="col-md-12">
                    ...
                    <table id="myTableDay" class=" table table-bordered table-striped table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT mp.id as product_id,
                                ...
                                SUM(
                                    CASE 
                                        WHEN m.sign_of_calculation = 'priemka' THEN (m.count * mp.volume)
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                {
                                        ?>
                                        <tr class="<?= $data['total_volume_by_product'] == $data['volume'] ? 'table-success' : 'table-warning' ?>">
                                            <td><?= $data['type_name'] ?></td>
                                            <td><a href="/maslosklad/barrel_bottling.php?product_id=<?= $data['product_id'] ?>"><?= $data['product_name'] ?></a></td>
