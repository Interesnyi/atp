     ...
     <div class="container mt-4">
        ...
        ?>
            ...
            <div class="col-md-12 mt-2">
                ...
                <p>Посмотреть приём / выдачу в разделе <b><a href="car_parts.php">ELDIR | ЗАПЧАСТИ (выдача/приём) ".</a></b></p>
            </div>
            <div class="col-md-12">
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                foreach($query_run as $data)
                                {
                                        ...
                                        <tr class="<?= $data['total_volume_by_product'] > 1 ? 'table-success' : 'table-warning' ?>">
                                            ...
                                            <td><a href="/maslosklad/car_parts.php?product_id=<?= $data['product_id'] ?>"><?= $data['product_name'] ?></a></td>
