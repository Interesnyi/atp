...
function get_text_type_payment($number){
    ...
    if( $number == 6) return 'Штрафы / пени';
...
<html lang="en">
  <head>
    ...
    <title>ELDIR | Касса | Приход </title>
...
<body>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="type_payment" class="form-select">
                            ...
                            <option value="2" selected>Оплата товара</option>
                        </select>
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="type_payment" name="type_payment" class="form-select">
                            <option value="0">Выберите тип платежа</option>
                            <option value="1" selected>Оплата услуги</option>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12">
                <h1>ELDIR | Модуль Касса | Приход </h1>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
				...
				<button type="button" class="getInfoBtn btn btn-success"  style="display:none;">
                ...
                <div class="table-responsive-sm">
                    <table id="myTable" class=" table table-bordered table-striped table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM balance_income_expenses WHERE sign_of_calculation = 'income' AND is_deleted=0";
