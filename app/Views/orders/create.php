            ...
            <div class="col-md-6">
                ...
                <select class="form-select" id="contract_id" name="contract_id">
                    ...
                    <?php foreach ($contracts as $contract): ?>
                        <option value="<?= $contract['id'] ?>">№<?= htmlspecialchars($contract['contract_number']) ?> от <?= htmlspecialchars($contract['contract_date']) ?> (<?= htmlspecialchars($contract['company_name'] ?: $contract['contact_person']) ?>)</option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
