<div class="card mt-4">
    <div class="card-header">
        <h5 class="mb-0">Редактировать имущество</h5>
    </div>
    <div class="card-body">
        <form action="/warehouses/items/update/<?= $item['id'] ?>" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="article" name="article" value="<?= htmlspecialchars($item['article']) ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="has_volume" name="has_volume">
                    <option value="0" <?= !$item['has_volume'] ? 'selected' : '' ?>>Нет</option>
                    <option value="1" <?= $item['has_volume'] ? 'selected' : '' ?>>Да</option>
                </select>
            </div>
