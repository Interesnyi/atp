        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Добавить поставщика</h5>
                    <a href="/warehouses/suppliers" class="btn btn-outline-secondary btn-sm">
                        <i class="bi bi-arrow-left"></i> К списку
                    </a>
                </div>
                <form method="post" action="/warehouses/api/suppliers/create" class="card-body needs-validation" novalidate>
                    <div class="mb-3">
                    ...
                    <div class="text-end">
                        ...
                        <a href="/warehouses/suppliers" class="btn btn-outline-secondary ms-2">Отмена</a>
                    </div>
                </form>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('/warehouses/api/suppliers/create', {
            method: 'POST',
            body: formData,
        ...
        .then(data => {
            if (data.success) {
                window.location.href = '/warehouses/suppliers?added=1';
            } else {
