<?php // @var $customers array, $contracts array ?>
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/">Главная</a></li>
            <li class="breadcrumb-item"><a href="/examinations">Экспертизы</a></li>
            <li class="breadcrumb-item active" aria-current="page">Новая экспертиза</li>
        </ol>
    </nav>
    <h2>Новая экспертиза</h2>
    <form method="post" action="/examinations/store">
        <div class="row">
