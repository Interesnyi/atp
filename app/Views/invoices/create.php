<?php /** @var array $legalEntities */ ?>
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12 col-md-8 col-lg-6 mx-auto">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h4 class="mb-0">Создать новый счёт</h4>
                </div>
                <div class="card-body">
                    <form method="post" action="/invoices/store">
                            ...
                            <div class="row mb-1 align-items-center">
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="status_issued" name="status_issued" value="1">
                                        <label class="form-check-label" for="status_issued">Выставлен</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <input type="date" class="form-control form-control-sm" id="date_issued" name="date_issued" placeholder="Дата выставления">
                                </div>
                            </div>
                            <div class="row mb-1 align-items-center">
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="status_shipped" name="status_shipped" value="1">
                                        <label class="form-check-label" for="status_shipped">Отгружен</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <input type="date" class="form-control form-control-sm" id="date_shipped" name="date_shipped" placeholder="Дата отгрузки">
                                </div>
                            </div>
                            <div class="row mb-1 align-items-center">
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="status_paid" name="status_paid" value="1">
                                        <label class="form-check-label" for="status_paid">Оплачен</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <input type="date" class="form-control form-control-sm" id="date_paid" name="date_paid" placeholder="Дата оплаты">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <a href="/invoices" class="btn btn-secondary">Отмена</a>
                    </form>
                </div>
            </div>
        </div>
