-- Создаем таблицу групп разрешений
...
-- Создаем таблицу ролевых разрешений
...
-- Добавляем основные группы разрешений
INSERT INTO permission_groups (name, slug, description) VALUES
